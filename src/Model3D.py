...
class Triangle(object):
    ...
    def find_interpolated_points_at_z(self, targetz):
        ...
        if (self.vertices[0].z > targetz and self.vertices[1].z < targetz) or (
                self.vertices[0].z < targetz and self.vertices[1].z > targetz):
        ...
        if (self.vertices[0].z > targetz and self.vertices[2].z < targetz) or (
                self.vertices[0].z < targetz and self.vertices[2].z > targetz):
        ...
        if (self.vertices[1].z > targetz and self.vertices[2].z < targetz) or (
                self.vertices[1].z < targetz and self.vertices[2].z > targetz):
